...
namespace Code.Rewards
{
    public class WeeklyRewardView : MonoBehaviour, IBaseRewardView
    {
        ...
        [SerializeField] private Button _goBackToDailyRewardButton;
        [SerializeField] private Button _goBackToMainMenuButton;
        ...
        public Button GOBackToDailyRewardButton => _goBackToDailyRewardButton;
        public Button GoBackToMainMenuButton => _goBackToMainMenuButton;
